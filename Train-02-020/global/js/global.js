...
$(document).ready(function () {
  ...
  // Select all elements with the class 'footer-sub-tab'
  $('.footer-sub-tab').each(function() {
        // Check if any of the footer-sub-tab elements have the 'active' class
        if ($('.footer-sub-tab.active').length > 0) {
          console.log("Hi");
          // If any footer-sub-tab has the 'active' class, add the 'active' class to the footer-tab
          $('.footer-tab').addClass('active');
      }
  });

  $(".footer li").on("touchend click", function (e) {
    let id = $(this).data("id");
    if (id == "chart") {
      $(".footer-sub-tab.about").removeClass("active");
      $(".footer-sub-tab.chart").addClass("active");
      $('.footer-tab').addClass('active');
    } else if (id == "about") {
      $(".footer-sub-tab.chart").removeClass("active");
      $(".footer-sub-tab.about").addClass("active");
      $('.footer-tab').addClass('active');
    } else {
      window.goToSlide(id);
    }
